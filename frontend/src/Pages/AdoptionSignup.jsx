    ...
    <>
      <div className="flex justify-center items-center h-[88vh] w-full">
        <div className="bg-[#d4c7aa] w-[70%] h-[88vh] flex justify-center items-center">
          <form className="bg-[#f6eeda] border-solid border-[3px] border-[#676f58] h-[80vh] w-[80%] flex justify-evenly items-center rounded-xl">
            <div className="bg-[#d4c7aa] w-2/5 h-[72vh] flex flex-col justify-around items-center border-[2px] border-solid border-[#676f58] rounded-[15px]">
              <h2 className="text-[2em] text-[#676f58] font-bold m-0">Register for Adoption</h2>

              <div className="w-[85%] h-[23vh] flex flex-col justify-between items-center">
                <div className="w-[90%] flex flex-col items-start gap-1">
                  <p>Your Name</p>
                  <input name="name" className="w-[100%] bg-[#f6eeda] h-8 border border-[#676f58] rounded-lg p-2" type="text" placeholder="Your Name" required />
                </div>
                <div className="w-[90%] flex flex-col items-start gap-1">
                  <p>Your E-mail</p>
                  <input name="email" className="w-[100%] bg-[#f6eeda] h-8 border border-[#676f58] rounded-lg p-2" type="email" placeholder="Your E-mail" required />
                </div>
                <div className="w-[90%] flex flex-col items-start gap-1">
                  <p>Your Password</p>
                  <input name="password" className="w-[100%] bg-[#f6eeda] h-8 border border-[#676f58] rounded-lg p-2" type="password" placeholder="Password" required />
                </div>
              </div>
              ...
              <div className="w-[77%] h-32 flex flex-col justify-evenly items-start">
                ...
                <p className="m-0 mt-[45px]">
                  Already have an Account? <Link to={'/AdoptionLogin'}><span className="underline text-blue-500">Login</span></Link>
                </p>
              </div>
